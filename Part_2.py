...
#    dm.setActuators(act)
    img=grabframes(5,2)
    plt.imshow(img[-1])
#        imsave(f"C:\\AO-course-2024\\part_2\\frames\\frame_0.png", img[-1])
#        np.savetxt(f"C:\\AO-course-2024\\part_2\\raw\\frame_0.dat", img[-1])
#        # Run loop
#        if True:
#            act=np.zeros([len(dm)])
...
#                print(act)
#                img=grabframes(5)
#                imsave(f"C:\\AO-course-2024\\part_2\\frames\\frame_{i+1}.png", img[-1])
#                np.savetxt(f"C:\\AO-course-2024\\part_2\\raw\\frame_{i+1}.dat", img[-1])
#                # plt.colorbar()
#        act=np.zeros([len(dm)])
#        dm.setActuators(act)
